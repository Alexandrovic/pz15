...
class NavigationTest(BaseCase):
    ...
    def test_03_find_items(self):
        ...
        self.send_keys('//*[@id="search-form"]/input', "mini rodini")
    ...
    def test_05_change_region(self):
        ...
        self.sleep(0.3)
        eng_price = self.get_text('//article[1]/a/div[2]/p[3]')
        self.sleep(0.3)
        ...
        ru_price = self.get_text('//article[1]/a/div[2]/p[3]')
        # английский текст не должен совпадать с русским
        self.assert_equal(eng_text, ru_text)
        self.sleep(0.3)
